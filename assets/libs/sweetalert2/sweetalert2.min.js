!(function (e, t) {
  ...
  const z = { previousBodyPadding: null },
    ...
    pe = () => {
      de.previousActiveElement && de.previousActiveElement.focus
        ? (de.previousActiveElement.focus(), (de.previousActiveElement = null))
    ...
    Pe = (e, t) => {
      var n,
        ...
        s = H(),
        c = D();
      (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? te : ne)(
        s
      ),
        Y(s, t, "actions"),
        (n = s),
  ...
  const xe = (e, t) => {
    ...
    i &&
      ...
      "string" == typeof (n = t.backdrop)
        ...
        : n || $([document.documentElement, document.body], w["no-backdrop"]),
      (o = i),
      (n = t.position) in w
        ? $(o, w[n])
        ...
        o.progressSteps.forEach((e, t) => {
          var n,
            e =
              ...
              e);
          i.appendChild(e),
            t === o.currentProgressStep && $(e, w["active-progress-step"]),
    ...
    vt = (e, t, n) => {
      $(e, n.showClass.backdrop),
        ...
        n.heightAuto &&
          n.backdrop &&
          !n.toast &&
          $([document.documentElement, document.body], w["height-auto"]);
    },
    wt = (e) => {
      let t = B();
      t || new fn(), (t = B());
      ...
      t.container.onmousedown = () => {
        t.popup.onmouseup = function (e) {
          (t.popup.onmouseup = void 0),
            (e.target !== t.popup && !t.popup.contains(e.target)) || (jt = !0);
        };
      };
    },
    It = (n, o, i) => {
  ...
  const Qt = (e) => {
      e.isAwaitingPromise() &&
        (Ee.awaitingPromise.delete(e), Ee.innerParams.get(e) || e._destroy());
    },
    en = (e, t, n) => {
      var o,
        i,
      ...
      "function" == typeof n.willClose && n.willClose(t),
        s
          ? ((o = e),
            ...
            (s = n.returnFocus),
            (t = n.didClose),
            (de.swalCloseEventFinishedCallback = $t.bind(null, o, a, s, t)),
      ...
      t
        ? (e.popup &&
          ...
          de.deferDisposalTimer &&
            (clearTimeout(de.deferDisposalTimer), delete de.deferDisposalTimer),
  ...
  class cn {
    ...
    _main(e) {
      ...
      v(Object.assign({}, t, e)),
        de.currentInstance && (de.currentInstance._destroy(), F() && $e()),
  ...
  const ln = (r, s, c) =>
        ...
        Xt.swalPromiseResolve.set(r, e),
          ...
          (s.denyButton.onclick = () =>
            ((e) => {
              var t = Ee.innerParams.get(e);
              e.disableButtons(),
                t.returnInputValueOnDeny ? xt(e, "deny") : Et(e, !1);
            })(r)),
    ...
    un = (e, t) => {
      var n = ((e) => {
        ...
        e = e.content;
        return (
          at(e), Object.assign(Qe(e), et(e), tt(e), nt(e), ot(e), it(e, Ge))
        );
      })(e);
    ...
    mn = (e, t) => {
      if (!t.toast)
        return l(t.allowEnterKey) ? void (gn(e, t) || qt(t, -1, 1)) : hn();
    },
    gn = (e, t) =>
