    ...
    <script src="<?php echo base_url() ?>assets/libs/datatables/dataTables.bootstrap5.min.js"></script>
    <!-- Responsive examples -->
...
function openEditData(id) {
    $.ajax({
        ...
        success: function(data) {
            // console.log(data);
            $("#chProfilenamee").val(data.NAME);
            $("#chProfileemailAddress").val(data.EMAIL);
            $("#chProfilepositionUser").val(data.POSITION);
            $("#IDchProfile").val(data.ID);
